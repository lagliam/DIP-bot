...
REPORT_HELP = 'Report a message to the bot owner'
REPORT_SENT = 'Report has been sent successfully'
REPORT_UNABLE_TO_FIND = 'Unable to find message, ensure message id was copied correctly'
REPORT_FAILED = 'Unable to file a report'
REPORT_NOT_A_BOT_MESSAGE = 'Message was not sent by the bot, unable to report'
